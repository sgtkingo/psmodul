...
DPD.hypergeo_disc <- function(x, N, M, n, logic = "<=", q = 0.0, draw_plot = FALSE){
  result = 0.0
  reverse_logic = TRUE
  type = 'p'
  ...
  switch (type,
          ...
          'q' = { result = qhyper(q, M, N-M, n) }
  )
  if (draw_plot){
    plot(x, result, type='l', ylab = "P(x)")
    grid()
  }
...
DPD.binom_disc <- function(x, n, PI, logic = "<=", q = 0.0, draw_plot = FALSE){
  result = 0.0
  reverse_logic = TRUE
  type = 'p'
...
DPD.nbinom_disc <- function(x, k, PI, logic = "<=", q = 0.0, draw_plot = FALSE){
  result = 0.0
  reverse_logic = TRUE
  type = 'p'
...
DPD.pois_disc <- function(x, t, LAMBDA, logic = "<=", q = 0.0, draw_plot = FALSE){
  result = 0.0
  reverse_logic = TRUE
  type = 'p'
